  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-10 space-y-10 bg-emerald-50 animate-in fade-in duration-1000">
         ...
         <button onClick={() => setIsSuccess(false)} className="btn-primary-luxury px-12 py-5">Retour à l'expérience</button>
      </div>
    );
  }
    ...
    <div className="animate-in fade-in duration-1000 selection:bg-emerald-200">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-slate-950">
         ...
         <div className="relative z-10 text-center space-y-10 px-6 max-w-5xl">
            ...
            <div className="pt-10 flex flex-col md:flex-row gap-6 justify-center items-center animate-in slide-in-from-bottom-6 duration-1000 delay-500">
               <a href="#booking" className="px-12 py-6 bg-emerald-600 text-white rounded-3xl font-black uppercase text-xs tracking-[0.3em] shadow-2xl shadow-emerald-900/50 hover:bg-emerald-500 hover:-translate-y-1 transition-all duration-500 active:scale-95">Prendre Rendez-vous</a>
               <a href="#services" className="px-12 py-6 bg-white/5 backdrop-blur-xl text-white border border-white/10 rounded-3xl font-black uppercase text-xs tracking-[0.3em] hover:bg-white/10 transition-all duration-500">Expertises</a>
            </div>
         </div>
         ...
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-12">
            {[
               ...
               <div key={i} className="text-center space-y-1">
                  <p className="text-4xl font-black text-slate-900 italic tracking-tighter">{st.val}</p>
      ...
      <section className="py-40 bg-emerald-600 text-white relative overflow-hidden">
         <div className="max-w-5xl mx-auto px-10 text-center space-y-12 relative z-10">
            <Star className="w-12 h-12 mx-auto text-emerald-200 fill-emerald-200 opacity-40" />
      ...
      <section className="py-40 bg-slate-950 text-white overflow-hidden">
         <div className="max-w-7xl mx-auto px-6 space-y-24">
            <div className="flex flex-col md:flex-row justify-between items-end gap-8">
               ...
               <p className="max-w-md text-slate-500 font-medium text-lg leading-relaxed italic border-l-4 border-emerald-500 pl-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="md:col-span-2 h-[500px] rounded-[3rem] overflow-hidden group relative shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=2070&auto=format&fit=crop" alt="Maintenance" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[3s]" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 flex items-end p-12">
               ...
               <div className="h-[500px] rounded-[3rem] overflow-hidden group relative shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1507702553912-a15641e827c8?q=80&w=2073&auto=format&fit=crop" alt="Diagnostic" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[3s]" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 flex items-end p-12">
                     <p className="text-xl font-black uppercase tracking-tight">Analyse Digitale</p>
                  </div>
               </div>
               <div className="h-[500px] rounded-[3rem] overflow-hidden group relative shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1621905251918-48416bd8575a?q=80&w=2070&auto=format&fit=crop" alt="AC Service" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[3s]" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 flex items-end p-12">
                     <p className="text-xl font-black uppercase tracking-tight">Confort Thermique</p>
                  </div>
               </div>
               <div className="md:col-span-2 h-[500px] rounded-[3rem] overflow-hidden group relative shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?q=80&w=2070&auto=format&fit=crop" alt="Brakes" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[3s]" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 flex items-end p-12">
                     <p className="text-xl font-black uppercase tracking-tight">Système de Freinage Sport</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section id="booking" className="bg-[#f0f9f4] py-40">
         <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
               ...
               <div className="space-y-6">
                  <div className="flex items-center gap-6 text-slate-900 group cursor-pointer">
                     <div className="w-12 h-12 rounded-2xl bg-emerald-600 text-white flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform"><Phone className="w-6 h-6" /></div>
                     <div>
                  ...
                  <div className="flex items-center gap-6 text-slate-900 group cursor-pointer">
                     <div className="w-12 h-12 rounded-2xl bg-slate-900 text-emerald-400 flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform"><Mail className="w-6 h-6" /></div>
                     <div>
            ...
            <div className="card-luxury p-12 bg-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.05)] border-white">
               <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                     <div className="space-y-3">
                        ...
                        <input 
                           ...
                           className="w-full px-8 py-5 rounded-2xl bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white outline-none font-bold transition-all shadow-inner"
                           placeholder="Ex: Jean Zinsou"
                        />
                     </div>
                     <div className="space-y-3">
                        <label className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] ml-2">Ligne Téléphone</label>
                        <input 
                           type="tel" required 
                  ...
                  <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] ml-2">Nature de l'intervention</label>
                     <select 
                        value={bookingData.service}
                        onChange={e => setBookingData({...bookingData, service: e.target.value})}
                        className="w-full px-8 py-5 rounded-2xl bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white outline-none font-bold transition-all shadow-inner appearance-none"
                     >
                  ...
                  <div className="grid grid-cols-2 gap-8">
                     <div className="space-y-3">
                        <label className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] ml-2">Date</label>
                        <input 
                           type="date" required 
                     ...
                     <div className="space-y-3">
                        <label className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] ml-2">Horaire</label>
                        <select 
                  ...
                  <button 
                     ...
                     className="w-full py-6 bg-slate-900 text-white rounded-[1.5rem] font-black uppercase text-xs tracking-[0.3em] shadow-2xl hover:bg-emerald-600 transition-all duration-500 disabled:opacity-50 active:scale-95 flex items-center justify-center gap-4"
                  >
                     {isSubmitting ? <Clock className="w-5 h-5 animate-spin" /> : <ArrowRight className="w-5 h-5" />}
         ...
         <div className="max-w-7xl mx-auto px-6 space-y-24">
            <div className="flex flex-col md:flex-row justify-between items-center gap-10">
               ...
               <button 
                  ...
                  className="flex items-center gap-3 px-10 py-5 bg-emerald-50 text-emerald-700 rounded-3xl font-black text-xs uppercase tracking-widest hover:bg-emerald-600 hover:text-white transition-all duration-500 shadow-xl shadow-emerald-900/5 active:scale-95 group"
               >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
               {publicAvis.map((a: any, i: number) => (
                  <div key={i} className="p-10 rounded-[3rem] bg-[#f8fafc] border border-emerald-50/50 shadow-sm space-y-8 relative group hover:shadow-xl transition-all duration-700">
                     <div className="flex text-emerald-500">
                        {Array.from({length: a.note}).map((_, j) => <Star key={j} className="w-4 h-4 fill-emerald-500" />)}
                     </div>
                     <p className="text-xl font-black text-slate-900 leading-tight italic">"{a.commentaire}"</p>
                     <div className="pt-6 flex items-center gap-4 border-t border-emerald-100/50">
                        <div className="w-12 h-12 rounded-2xl bg-slate-900 text-emerald-400 flex items-center justify-center font-black text-lg shadow-xl">
         ...
         <div className="max-w-7xl mx-auto px-10 grid grid-cols-1 md:grid-cols-3 gap-20">
            <div className="space-y-8">
               ...
               <div className="flex gap-4">
                  {[1,2,3].map(i => <div key={i} className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:bg-emerald-500 transition-all cursor-pointer"></div>)}
               </div>
            </div>
            <div className="space-y-8">
               <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-emerald-500">Navigation</h4>
               <ul className="space-y-4 text-sm font-bold text-slate-400">
                  <li className="hover:text-white cursor-pointer transition-colors">Notre Vision</li>
                  <li className="hover:text-white cursor-pointer transition-colors">Équipe Technique</li>
                  <li className="hover:text-white cursor-pointer transition-colors">FAQ Maintenance</li>
                  <li className="hover:text-white cursor-pointer transition-colors">Politique Qualité</li>
               </ul>
            </div>
            <div className="space-y-8">
               ...
               <p className="text-sm font-bold text-emerald-400">+229 01 92 62 98 60</p>
      ...
      {showReviewForm && (
         <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-950/80 backdrop-blur-xl animate-in fade-in duration-500">
            <div className="max-w-md w-full bg-white p-12 rounded-[3rem] shadow-2xl space-y-10 relative overflow-hidden animate-in zoom-in-95 duration-700">
               <button onClick={() => setShowReviewForm(false)} className="absolute top-8 right-8 text-slate-300 hover:text-slate-900 transition-colors">
                  <X className="w-6 h-6" />
               </button>
               ...
               <form onSubmit={handlePublicReviewSubmit} className="space-y-8">
                  <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase text-emerald-600 tracking-[0.2em] ml-2">N° de Téléphone Client</label>
                     <input 
                        type="tel" required 
                        value={newReview.phone}
                        onChange={e => setNewReview({...newReview, phone: e.target.value})}
                        className="w-full px-8 py-5 rounded-2xl bg-slate-50 border-2 border-transparent focus:border-emerald-500 outline-none font-bold shadow-inner transition-all"
                        placeholder="01 02 03 04 05"
                     />
                  </div>
                  <div className="flex gap-4 justify-center py-4 bg-emerald-50/30 rounded-3xl">
                     {[1, 2, 3, 4, 5].map(star => (
                        <button key={star} type="button" onClick={() => setNewReview({...newReview, note: star})} className={`transition-all duration-500 hover:scale-125 ${star <= newReview.note ? 'text-orange-500' : 'text-slate-200'}`}>
                           <Star className={`w-8 h-8 ${star <= newReview.note ? 'fill-orange-500' : ''}`} />
                        </button>
                     ))}
                  </div>
                  <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase text-emerald-600 tracking-[0.2em] ml-2">Observations</label>
                     <textarea 
                        required rows={3}
                  ...
                  <button 
                     disabled={isSubmitting}
                     className="w-full py-6 bg-slate-900 text-white rounded-[1.5rem] font-black uppercase text-xs tracking-widest shadow-2xl hover:bg-emerald-600 transition-all duration-500 disabled:opacity-50 active:scale-95"
                  >
                     {isSubmitting ? 'Traitement...' : 'Publier mon avis'}
                  </button>
               </form>
      ...
      <div className="fixed bottom-10 right-10 flex flex-col gap-6 z-40 no-print">
         <a href="https://wa.me/2290192629860" target="_blank" className="w-16 h-16 bg-[#25D366] text-white rounded-[1.5rem] flex items-center justify-center shadow-2xl hover:scale-110 hover:rotate-6 transition-all group relative">
            <MessageSquare className="w-8 h-8" />
            <span className="absolute right-full mr-6 px-4 py-2 bg-slate-900 text-white text-[10px] font-black uppercase rounded-xl shadow-2xl opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none whitespace-nowrap translate-x-4 group-hover:translate-x-0 tracking-widest">WhatsApp Direct</span>
         </a>
         <a href="tel:+2290192629860" className="w-16 h-16 bg-white text-slate-900 rounded-[1.5rem] flex items-center justify-center shadow-2xl hover:scale-110 hover:-rotate-6 transition-all group relative border border-emerald-50">
            <Phone className="w-8 h-8 text-emerald-600" />
            <span className="absolute right-full mr-6 px-4 py-2 bg-slate-900 text-white text-[10px] font-black uppercase rounded-xl shadow-2xl opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none whitespace-nowrap translate-x-4 group-hover:translate-x-0 tracking-widest">Appel Audio</span>
         </a>
      </div>
    </div>
  );
